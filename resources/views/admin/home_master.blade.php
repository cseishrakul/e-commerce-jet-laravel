        ...
        <ul class="nav">
          ...
          <li class="nav-item menu-items">
            ...
            <div class="collapse" id="ui-basic">
              <ul class="nav flex-column sub-menu">
                ...
                <li class="nav-item"> <a class="nav-link" href="{{url('/show_category')}}">Show Category</a></li>
              </ul>
            </div>
          </li>
          <li class="nav-item menu-items">
            ...
            <div class="collapse" id="ui-basic">
              <ul class="nav flex-column sub-menu">
                ...
                <li class="nav-item"> <a class="nav-link" href="{{url('/show_banner')}}">Show Banner</a></li>
              </ul>
            </div>
          </li>
          <li class="nav-item menu-items">
          ...
          <li class="nav-item menu-items">
            ...
            <div class="collapse" id="ui-basic2">
              <ul class="nav flex-column sub-menu">
                <li class="nav-item"> <a class="nav-link" href="{{url('/show_order')}}">Show Order</a></li>
              </ul>
            </div>
          </li>
        </ul>
